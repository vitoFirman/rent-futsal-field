...
class FieldPolicy
{
     ...
     */
    public function forceDelete(User $user, Field $model): bool
    {
     ...
     */
    public function restore(User $user, Field $model): bool
    {
     ...
     */
    public function replicate(User $user, Field $model): bool
    {
